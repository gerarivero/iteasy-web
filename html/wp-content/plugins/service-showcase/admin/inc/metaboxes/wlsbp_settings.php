	...
	<div class="wlsbp-general-setting">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $display_service_title, true, true ); ?> class="form-check-input" type="radio" name="display_service_title" id="wlsbp_display_service_title_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $display_service_title, false, true ); ?> class="form-check-input" type="radio" name="display_service_title" id="wlsbp_display_service_title_0" value="0">
	...
	<div class="wlsbp-setting-style wlsbp-setting-style1">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s1_display_service_icon, true, true ); ?> class="form-check-input" type="radio" name="s1_display_service_icon" id="wlsbp_s1_display_service_icon_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s1_display_service_icon, false, true ); ?> class="form-check-input" type="radio" name="s1_display_service_icon" id="wlsbp_s1_display_service_icon_0" value="0">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s1_display_service_rmlink, true, true ); ?> class="form-check-input" type="radio" name="s1_display_service_rmlink" id="wlsbp_s1_display_service_rmlink_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s1_display_service_rmlink, false, true ); ?> class="form-check-input" type="radio" name="s1_display_service_rmlink" id="wlsbp_s1_display_service_rmlink_0" value="0">
	...
	<div class="wlsbp-setting-style wlsbp-setting-style2">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				...
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s2_display_service_icon, true, true ); ?> class="form-check-input" type="radio" name="s2_display_service_icon" id="wlsbp_s2_display_service_icon_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s2_display_service_icon, false, true ); ?> class="form-check-input" type="radio" name="s2_display_service_icon" id="wlsbp_s2_display_service_icon_0" value="0">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s2_display_service_rmlink, true, true ); ?> class="form-check-input" type="radio" name="s2_display_service_rmlink" id="wlsbp_s2_display_service_rmlink_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s2_display_service_rmlink, false, true ); ?> class="form-check-input" type="radio" name="s2_display_service_rmlink" id="wlsbp_s2_display_service_rmlink_0" value="0">
	...
	<div class="wlsbp-setting-style wlsbp-setting-style3">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s3_display_service_icon, true, true ); ?> class="form-check-input" type="radio" name="s3_display_service_icon" id="wlsbp_s3_display_service_icon_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s3_display_service_icon, false, true ); ?> class="form-check-input" type="radio" name="s3_display_service_icon" id="wlsbp_s3_display_service_icon_0" value="0">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s3_display_service_rmlink, true, true ); ?> class="form-check-input" type="radio" name="s3_display_service_rmlink" id="wlsbp_s3_display_service_rmlink_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s3_display_service_rmlink, false, true ); ?> class="form-check-input" type="radio" name="s3_display_service_rmlink" id="wlsbp_s3_display_service_rmlink_0" value="0">
	...
	<div class="wlsbp-setting-style wlsbp-setting-style4">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s4_display_service_icon, true, true ); ?> class="form-check-input" type="radio" name="s4_display_service_icon" id="wlsbp_s4_display_service_icon_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s4_display_service_icon, false, true ); ?> class="form-check-input" type="radio" name="s4_display_service_icon" id="wlsbp_s4_display_service_icon_0" value="0">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s4_display_service_rmlink, true, true ); ?> class="form-check-input" type="radio" name="s4_display_service_rmlink" id="wlsbp_s4_display_service_rmlink_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s4_display_service_rmlink, false, true ); ?> class="form-check-input" type="radio" name="s4_display_service_rmlink" id="wlsbp_s4_display_service_rmlink_0" value="0">
	...
	<div class="wlsbp-setting-style wlsbp-setting-style5">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s5_display_service_icon, true, true ); ?> class="form-check-input" type="radio" name="s5_display_service_icon" id="wlsbp_s5_display_service_icon_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s5_display_service_icon, false, true ); ?> class="form-check-input" type="radio" name="s5_display_service_icon" id="wlsbp_s5_display_service_icon_0" value="0">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s5_display_service_rmlink, true, true ); ?> class="form-check-input" type="radio" name="s5_display_service_rmlink" id="wlsbp_s5_display_service_rmlink_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s5_display_service_rmlink, false, true ); ?> class="form-check-input" type="radio" name="s5_display_service_rmlink" id="wlsbp_s5_display_service_rmlink_0" value="0">
	...
	<div class="wlsbp-setting-style wlsbp-setting-style6">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s6_display_service_icon, true, true ); ?> class="form-check-input" type="radio" name="s6_display_service_icon" id="wlsbp_s6_display_service_icon_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s6_display_service_icon, false, true ); ?> class="form-check-input" type="radio" name="s6_display_service_icon" id="wlsbp_s6_display_service_icon_0" value="0">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-check form-check-inline">
						<input <?php checked( $s6_display_service_rmlink, true, true ); ?> class="form-check-input" type="radio" name="s6_display_service_rmlink" id="wlsbp_s6_display_service_rmlink_1" value="1">
					...
					<div class="form-check form-check-inline">
						<input <?php checked( $s6_display_service_rmlink, false, true ); ?> class="form-check-input" type="radio" name="s6_display_service_rmlink" id="wlsbp_s6_display_service_rmlink_0" value="0">
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-group">
						...
						<div class="wlsbp-setting-helper fsize">
							<span class="ftitle5"><?php echo esc_attr( $s6_service_title_fontsize ); ?></span>
							<?php esc_html_e( 'px', 'service-showcase' ); ?>
						</div>
					</div>
				</span>
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-group">
						...
						<div class="wlsbp-setting-helper fsize">
							<span class="fdesc5"><?php echo esc_attr( $s6_service_desc_fontsize ); ?></span>
							<?php esc_html_e( 'px', 'service-showcase' ); ?>
						</div>
					</div>
				</span>
			...
			<div class="col-xs-12 col-md-8 wlsbp-setting-col">
				<span class="wlsbp_setting_value">
					<div class="form-group">
						...
						<div class="wlsbp-setting-helper fsize">
							<span class="frmlink5"><?php echo esc_attr( $s6_service_rmlink_fontsize ); ?></span>
							<?php esc_html_e( 'px', 'service-showcase' ); ?>
						</div>
					</div>
				</span>
