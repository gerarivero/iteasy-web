...
class WLSBP_ServiceShowcase_Admin {
	...
	public static function save_service_metaboxes( $post_id, $post ) {
		...
		$service_showcase_title       = ( isset( $_POST['service_showcase_title'] ) && is_array( $_POST['service_showcase_title'] ) ) ? array_map( 'sanitize_text_field', $_POST['service_showcase_title'] ) : array();
		$service_showcase_description = ( isset( $_POST['service_showcase_description'] ) && is_array( $_POST['service_showcase_description'] ) ) ? array_map( 'sanitize_text_field', $_POST['service_showcase_description'] ) : array();
		$service_showcase_link        = ( isset( $_POST['service_showcase_link'] ) && is_array( $_POST['service_showcase_link'] ) ) ? array_map( 'sanitize_text_field', $_POST['service_showcase_link'] ) : array();
			...
			foreach ( $service_showcase_icon as $key => $services ) {
				array_push(
					...
					array(
						...
						'link'  => ( isset( $service_showcase_link[ $key ] ) && ! empty( $service_showcase_link[ $key ] ) ) ? strip_tags( stripslashes( filter_var( $service_showcase_link[ $key ], FILTER_VALIDATE_URL ) ) ) : '',
					)
				);
			}
		...
		$s1_display_service_icon        = isset( $_POST['s1_display_service_icon'] ) ? (bool) ( $_POST['s1_display_service_icon'] ) : ture;
		$s1_display_service_rmlink      = isset( $_POST['s1_display_service_rmlink'] ) ? (bool) ( $_POST['s1_display_service_rmlink'] ) : ture;
		...
		$s2_display_service_icon        = isset( $_POST['s2_display_service_icon'] ) ? (bool) ( $_POST['s2_display_service_icon'] ) : ture;
		$s2_display_service_rmlink      = isset( $_POST['s2_display_service_rmlink'] ) ? (bool) ( $_POST['s2_display_service_rmlink'] ) : ture;
		...
		$s3_display_service_icon        = isset( $_POST['s3_display_service_icon'] ) ? (bool) ( $_POST['s3_display_service_icon'] ) : ture;
		$s3_display_service_rmlink      = isset( $_POST['s3_display_service_rmlink'] ) ? (bool) ( $_POST['s3_display_service_rmlink'] ) : ture;
		...
		$s4_display_service_icon        = isset( $_POST['s4_display_service_icon'] ) ? (bool) ( $_POST['s4_display_service_icon'] ) : ture;
		$s4_display_service_rmlink      = isset( $_POST['s4_display_service_rmlink'] ) ? (bool) ( $_POST['s4_display_service_rmlink'] ) : ture;
		...
		$s5_display_service_icon        = isset( $_POST['s5_display_service_icon'] ) ? (bool) ( $_POST['s5_display_service_icon'] ) : ture;
		$s5_display_service_rmlink      = isset( $_POST['s5_display_service_rmlink'] ) ? (bool) ( $_POST['s5_display_service_rmlink'] ) : ture;
		...
		$s6_display_service_icon        = isset( $_POST['s6_display_service_icon'] ) ? (bool) ( $_POST['s6_display_service_icon'] ) : ture;
		$s6_display_service_rmlink      = isset( $_POST['s6_display_service_rmlink'] ) ? (bool) ( $_POST['s6_display_service_rmlink'] ) : ture;
