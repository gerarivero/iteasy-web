		...
		<div class="wlsbp <?php echo esc_attr( $s6_service_grid_layout ); ?> col-sm-6 sbp_grid">
			<div class="ServiceShowcase wlsbp-style6-service-bg-color-<?php echo esc_attr( $id ); ?>">
				...
				<?php if ( ! empty( $service['title'] ) ) { ?>
					<h3 class="wlsbp-style6-service-title wlsbp-style6-service-title-<?php echo esc_attr( $id ); ?>"><?php echo esc_html( $service['title'] ); ?></h3>
				<?php } ?>
				<?php if ( ! empty( $service['desc'] ) ) { ?>
					<p class="wlsbp-style6-service-desc wlsbp-style6-service-desc-<?php echo esc_attr( $id ); ?>"><?php echo esc_html( $service['desc'] ); ?></p>
				<?php } ?>
				<?php if ( $s6_display_service_rmlink ) { ?>
				<a target="_blank" href="<?php echo esc_url( $service['link'] ); ?>" class="wlsbp-style6-service-readmore wlsbp-style6-service-readmore-<?php echo esc_attr( $id ); ?>">Read More</a>
				<?php } ?>
			</div>
		</div>
				<?php
