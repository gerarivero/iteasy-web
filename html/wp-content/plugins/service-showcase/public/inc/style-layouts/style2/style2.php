		...
		<div class="wlsbp <?php echo esc_attr( $s2_service_grid_layout ); ?> col-sm-6 sbp_grid">
			<div class="ServiceShowcase wlsbp-style2-service-bg-color-<?php echo esc_attr( $id ); ?>">
				...
				<?php if ( ! empty( $service['title'] ) ) { ?>
					<h3 class="wlsbp-style2-service-title wlsbp-style2-service-title-<?php echo esc_attr( $id ); ?>"><?php echo esc_html( $service['title'] ); ?></h3>
				<?php } ?>
				<?php if ( ! empty( $service['desc'] ) ) { ?>
					<p class="wlsbp-style2-service-desc wlsbp-style2-service-desc-<?php echo esc_attr( $id ); ?>"><?php echo esc_html( $service['desc'] ); ?></p>
				<?php } ?>
